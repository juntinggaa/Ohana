# 后台审计 · Backstage Audit

> **"后台审计不是一个待办清单，而是一个家庭责任交接系统。"**
> Backstage Audit is not a to-do list. It is a responsibility transfer system for families.

---

## 一、产品定位

**后台审计** 是一个 AI 家庭照护 Agent，把混乱的家庭消息（家庭群、医院提醒、学校通知、物业短信）转化成 **可执行、可追踪、可审计的责任流程**，让一直在记住、协调、兜底的那个人被看见。
